      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in delay-500">
            ...
            <a href="/SounakMaiti_Resume.pdf" download="SounakMaiti_Resume.pdf" className="inline-flex items-center px-8 py-3 border border-gray-600 rounded-lg text-gray-300 font-medium hover:border-blue-400 hover:text-blue-400 transition-all duration-300 hover:scale-105">
